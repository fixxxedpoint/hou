...
normalize = do
  describe "normalize (\\lambda x . x) (\\lambda x . x)" $ do
    it "should return \\lambda x . x" $ do
      let term = App (Abs (Implication (Implication someType someType) (Implication someType someType)) (Var (0, (Implication someType someType)))) (Abs someType (Var (0, someType))) (Implication someType someType)
  ...
  describe "normalize (\\lambda x . \\lambda y . x) z" $ do
    it "should return \\lambda y . z" $ do
      let term = App (Abs someType (Abs someType (Var (1, someType)))) (Var (2, someType)) (Implication someType someType)
...
preunify = do
  ...
  describe "preunify easy" $ do
    it "should create a substition for flex-rigid term" $ do
      let term1 = MetaVar (0, Implication someType someType)
  ...
  describe "preunify simple implication" $ do
    it "should return proper substitution" $ do
      let term1 = App (App (Constant ("->", Implication someType (Implication someType someType))) (FreeVar (0, someType)) (Implication someType someType)) (FreeVar (0, someType)) (someType)
      let term2 = MetaVar (0, someType)
      let equation = (term1, term2)
